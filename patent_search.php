...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['search_keyword'])) {
    ...
    $stmt = $mysqli->prepare("SELECT * FROM Patent WHERE Patent_Type LIKE ? OR Patent_Term LIKE ?");
    ...
    if (count($search_results) === 0) {
        ...
        echo '<tr style="background:#007bff;color:#fff;"><th>專利ID</th><th>教師編號</th><th>專利類型</th><th>專利名稱/內容</th><th>操作</th></tr>';
